...
* 使用 Trident 时可能会遇到的一个常见问题 https://azure.microsoft.com/en-us/services/netapp/["Azure NetApp Files"] 租户和客户端密码来自权限不足的应用程序注册。有关 Trident 要求的完整列表，请参见 https://docs.netapp.com/us-en/trident/trident-use/anf.html["Azure NetApp Files"] Configuration
